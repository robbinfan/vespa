...
%else
BuildRequires: vespa-protobuf-devel = 3.18.0-1.el7
BuildRequires: vespa-brpc-devel >= 0.9.7-12.el7
%endif
%else
...
%else
Requires: vespa-protobuf >= 3.18.0-1.el7
Requires: vespa-brpc >= 0.9.7-12.el7
%endif
%else
